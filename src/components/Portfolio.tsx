      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-16">
            {projects.map((project, index) => <Card key={index} className="border-none shadow-primary hover:shadow-accent transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                    ...
                    <div className={`p-8 lg:p-12 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.techStack.map((tech, techIndex) => <Badge key={techIndex} variant="secondary" className="bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground">
                              {tech}
                            </Badge>)}
                        </div>
                      </div>
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-2">
                          {project.keyFeatures.slice(0, 3).map((feature, featureIndex) => <li key={featureIndex} className="flex items-start gap-2">
                      ...
                      <div className="mb-8">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                          {project.achievements.map((achievement, achievementIndex) => <div key={achievementIndex} className="bg-muted/50 p-3 rounded-lg">
