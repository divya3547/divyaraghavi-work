...
const experiences = [
  {
    ...
    achievements: [
      "Architected microservices for real-time payment processing",
      "Implemented PSD2 compliance standards",
  ...
  },
  {
    ...
    achievements: [
      ...
      "Integrated Azure Cognitive Services for AI recommendations",
  ...
  },
  {
    ...
    achievements: [
      "Created real-time trading analytics dashboard",
      "Reduced trade settlement time by 40%",
      "Implemented automated risk calculation engine"
    ],
  ...
  },
  {
    ...
    achievements: [
      "Developed automated claims processing system",
      "Improved customer portal performance by 50%",
      "Integrated multiple third-party insurance APIs"
    ],
                ...
                <Card className={`border-none shadow-primary hover:shadow-accent transition-all duration-300 hover:-translate-y-1 ${index % 2 === 0 ? 'md:mr-8' : 'md:ml-8'}`}>
                  <CardContent className="p-8">
                    <div className={`${index % 2 === 0 ? '' : 'md:text-right'}`}>
                      ...
                      <h4 className="text-xl font-semibold text-accent mb-2">{exp.company}</h4>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.technologies.map((tech, i) => (
                          <Badge key={i} variant="secondary" className="bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground">
                            {tech}
                          </Badge>
                        ))}
                      </div>
